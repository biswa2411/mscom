  ...
  return (
    <div className="p-[5%]">
      <div className="flex-row md:flex gap-3">
        <div className="md:w-[50%] md:flex justify-between items-start">
        ...
        <div className="md:w-[50%] flex flex-col gap-2">
          ...
          <h3 className="text-[#000000] font-[16px]">
            ...
            voluptas placeat, recusandae fugit neque vel velit odio laborum quia
            odit necessitatibus eligendi, natus sed officia eos provident iure
            veritatis amet?
          </h3>
          ...
          <div className="py-2 space-y-2">
            ...
            <p>
              ...
              memories into beautiful artworks. You can choose digital painting
              and our artists will create your custom artworks with high quality
              and fast delivery. You can also customize and revise your artworks
              until you are happy.
            </p>
            <p>
              We offer different services to turn your photos, ideas, or
      ...
      {/* Related Products */}
      <div>
        <h3 className="flex justify-center items-center text-[#000000] text-[16px] md:text-[26px] lg:text-[32px] font-bold bg-[#F0F0F0] py-[3%]">
          Related Products
        </h3>
      </div>
    </div>
